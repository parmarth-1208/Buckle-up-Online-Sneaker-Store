              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      <tr>
                        <td>Yeezy Boost Zebra <strong class="mx-2">x</strong> 1</td>
                        <td>Rs.50,000.00</td>
                      </tr>
                      <tr>
                        <td>Brown Leather <strong class="mx-2">x</strong> 1</td>
                        <td>Rs.10,000.00</td>
                      </tr>
                      <tr>
                        <td>Converse Chuck 70 <strong class="mx-2">x</strong> 1</td>
                        <td>Rs.9,000.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
                        <td class="text-black">Rs69,000.00</td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                        <td class="text-black font-weight-bold"><strong>Rs.69,000.00</strong></td>
                      </tr>
                    </tbody>
                  </table>
