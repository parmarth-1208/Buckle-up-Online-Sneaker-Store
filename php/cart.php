                ...
                <tbody>
                    ...
                    foreach($_SESSION['cart'] as $key => $value){
                      ...
                      echo"
                        <tr>
                            ...
                            <td>$value[Price]</td>
                            <td><input class='btn btn-outline-primary js-btn-plus' type='number' value ='$value[Quantity]'min='1' max='5'</td>
                            <td>
                              <form action='managecart.php' method='POST'>
                                <button href='index.php' name='Remove_item' class='btn btn-outline-primary js-btn-plus'>REMOVE</button>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/yeezy8.png" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Yeezy Boost Zebra</h2>
                    </td>
                    <td>Rs.50,000.00</td>
                    <td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/formal13.png" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Brown Leather</h2>
                    </td>
                    <td>Rs.10,000.00</td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/conv4.png" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Converse Chuck 70</h2>
                    </td>
                    <td>Rs.9,000.00</td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
            ...
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                   <button type="submit" class="btn btn-primary btn-lg btn-block">Procced To Checkout></button>
                  </div>
                  </form>
                </div>
              </div>
